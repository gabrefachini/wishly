      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <section className="rounded-modal bg-surface p-5 shadow-card ring-1 ring-border">
          ...
          <div className="grid gap-3">
            {items.map((item) => (
              <div key={item.id} className="rounded-card bg-warm-50/60 p-4">
        ...
        <section className="rounded-modal bg-surface p-5 shadow-card ring-1 ring-border">
          ...
          <div className="mt-4 grid gap-4">
            <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("admin.title")} value={values.title} onChange={(event) => setValues((current) => ({ ...current, title: event.target.value }))} />
            <textarea className="min-h-24 rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("admin.description")} value={values.description} onChange={(event) => setValues((current) => ({ ...current, description: event.target.value }))} />
            <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("admin.destinationUrl")} value={values.destination_url} onChange={(event) => setValues((current) => ({ ...current, destination_url: event.target.value }))} />
            <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("giftForm.productImage")} value={values.image_url} onChange={(event) => setValues((current) => ({ ...current, image_url: event.target.value }))} />
            <select className="rounded-ctrl border border-border bg-surface px-4 py-3" value={values.merchant_id} onChange={(event) => setValues((current) => ({ ...current, merchant_id: event.target.value }))}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("admin.category")} value={values.category} onChange={(event) => setValues((current) => ({ ...current, category: event.target.value }))} />
              <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("create.occasion")} value={values.occasion} onChange={(event) => setValues((current) => ({ ...current, occasion: event.target.value }))} />
            </div>
            <div className="grid gap-4 sm:grid-cols-3">
              <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("giftForm.estimatedPrice")} value={values.price} onChange={(event) => setValues((current) => ({ ...current, price: event.target.value }))} />
              <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("common.currency")} value={values.currency} onChange={(event) => setValues((current) => ({ ...current, currency: event.target.value }))} />
              <input className="rounded-ctrl border border-border bg-surface px-4 py-3" placeholder={t("admin.priority")} value={values.priority} onChange={(event) => setValues((current) => ({ ...current, priority: event.target.value }))} />
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <select className="rounded-ctrl border border-border bg-surface px-4 py-3" value={values.locale} onChange={(event) => setValues((current) => ({ ...current, locale: event.target.value as typeof values.locale }))}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <input type="datetime-local" className="rounded-ctrl border border-border bg-surface px-4 py-3" value={values.starts_at} onChange={(event) => setValues((current) => ({ ...current, starts_at: event.target.value }))} />
              <input type="datetime-local" className="rounded-ctrl border border-border bg-surface px-4 py-3" value={values.ends_at} onChange={(event) => setValues((current) => ({ ...current, ends_at: event.target.value }))} />
            </div>
