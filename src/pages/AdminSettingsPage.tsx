    ...
    <div className="grid gap-6">
      ...
      <section className="rounded-modal bg-surface p-5 shadow-card ring-1 ring-border">
        <dl className="grid gap-4">
          <div>
            <dt className="text-xs font-semibold uppercase tracking-[0.16em] text-primary">{t("admin.currentAdminEmail")}</dt>
            <dd className="mt-1 text-base font-semibold text-warm-900">{session?.user.email}</dd>
          </div>
          <div>
            <dt className="text-xs font-semibold uppercase tracking-[0.16em] text-primary">{t("admin.affiliateDisclosureEnabled")}</dt>
            <dd className="mt-1 text-base font-semibold text-warm-900">
              {env.affiliateDisclosureEnabled ? "true" : "false"}
            </dd>
          </div>
          <div>
            <dt className="text-xs font-semibold uppercase tracking-[0.16em] text-primary">{t("admin.defaultAffiliateBehavior")}</dt>
            <dd className="mt-1 text-base font-semibold text-warm-900">database-driven fallback</dd>
          </div>
          <div>
            <dt className="text-xs font-semibold uppercase tracking-[0.16em] text-primary">{t("admin.supportedLocales")}</dt>
