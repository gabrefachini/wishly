    ...
    <main className="min-h-screen bg-page px-4 py-5 sm:px-6">
      <div className="mx-auto grid max-w-3xl gap-6">
        <div className="flex items-center justify-between gap-4">
          <Link to="/" className="inline-flex rounded-full bg-surface px-4 py-3 shadow-card ring-1 ring-border focus:outline-none focus:ring-4 focus:ring-primary/15">
            <WishlyLogo size="sm" />
          </Link>
        </div>

        <section className="rounded-modal bg-surface p-6 shadow-soft ring-1 ring-border">
          <p className="text-sm font-semibold text-primary">{t("app.promise")}</p>
